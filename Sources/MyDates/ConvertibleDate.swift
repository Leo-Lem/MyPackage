...
public func getDate<T: ConvertibleDate>(_ date: T) -> Date {
    date.getDate()
}
public func getString<T: ConvertibleDate>(_ date: T, withDateFormat: String = ConvertibleDateSettings.dateFormat) -> String {
    date.getString(withDateFormat)
}
public func getComps<T: ConvertibleDate>(_ date: T, withDateComponents: Set<Calendar.Component> = ConvertibleDateSettings.dateComponents) -> DateComponents {
    date.getComponents(withDateComponents)
}
