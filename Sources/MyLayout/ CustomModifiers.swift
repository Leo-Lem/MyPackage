...
extension View {
    ...
    public func customBackground(_ color: Color = .black.opacity(LayoutDefaults().opacity),
    ...
    public func customRowBackground(_ color: Color = Color.black.opacity(LayoutDefaults().opacity),
                                    cornerRadius: CGFloat = LayoutDefaults().cornerRadius,
                                    shadowRadius: CGFloat = LayoutDefaults().shadowRadius,
                                    shadowOffset: CGFloat = LayoutDefaults().shadowOffset) -> some View {
        self.modifier(
